...
reinitialize
load 1yy9_a_section_A_1ivo_a_section_A.pdb
bg_color white
color grey

# === HIERARCHICAL DOMAIN STRUCTURE COLORING ===
select domain_0, resi 285-308
color red, domain_0  # Domain 0 (MOVING)

select domain_1, resi 310-508
color blue, domain_1  # Domain 1 (GLOBAL REFERENCE)

# Color bending residues
select bending_residues_1, resi 284-284
color green, bending_residues_1
select bending_residues_2, resi 309-309
...
load output
load 1yy9_a_section_A_1ivo_a_section_A_arrows.pdb
...
hide everything, 1yy9_a_section_A_1ivo_a_section_A_arrows
