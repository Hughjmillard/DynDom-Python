...
# Shaft color: blue (moving domain), Head color: yellow (fixed domain)
...
# Display arrow head as clean cone (FIXED domain color: yellow)
show sticks, head_1
color yellow, head_1
...
# Shaft color: red (moving domain), Head color: yellow (fixed domain)
...
print 'Moving domain 0: Chain A, yellow shaft with blue head, 53.0° rotation'
print 'Moving domain 1: Chain B, yellow shaft with red head, 46.1° rotation'