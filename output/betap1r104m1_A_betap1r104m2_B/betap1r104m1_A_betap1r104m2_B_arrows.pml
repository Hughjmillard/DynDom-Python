...
load output\betap1r104m1_A_betap1r104m2_B\betap1r104m1_A_betap1r104m2_B.pdb

# Load arrows
load betap1r104m1_A_betap1r104m2_B_arrows.pdb

# Basic protein display
hide everything, output\betap1r104m1_A_betap1r104m2_B\betap1r104m1_A_betap1r104m2_B
show cartoon, output\betap1r104m1_A_betap1r104m2_B\betap1r104m1_A_betap1r104m2_B
color gray80, output\betap1r104m1_A_betap1r104m2_B\betap1r104m1_A_betap1r104m2_B

# Hide arrow atoms initially
hide everything, betap1r104m1_A_betap1r104m2_B_arrows

# Arrow 1: Domain 0 (moving) relative to Domain 1 (fixed)
# Shaft color: blue (fixed domain), Head color: red (moving domain)
# Rotation: 20.3°, Translation: 0.8Å
...
# Arrow 2: Domain 2 (moving) relative to Domain 1 (fixed)
# Shaft color: blue (fixed domain), Head color: yellow (moving domain)
# Rotation: 8.2°, Translation: 0.1Å
...
print 'Moving domain 0: Chain A, red shaft (fixed) with blue head (moving), 20.3° rotation'
print 'Moving domain 2: Chain B, red shaft (fixed) with yellow head (moving), 8.2° rotation'